...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("icons/三角点.bmp"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.point_sanjiao.setIcon(icon)
        self.point_sanjiao.setIconVisibleInMenu(True)
        ...
        self.toolBar.addAction(self.point_sanjiao)
        self.toolBar.addAction(self.point_tianwendian)
        self.toolBar.addAction(self.point_yancong)
        self.toolBar.addAction(self.point_chuyouguan)
        self.toolBar.addAction(self.point_guta)
        self.toolBar.addAction(self.point_fadian)
        self.toolBar.addSeparator()
        self.toolBar.addAction(self.line_airplane)
        self.toolBar.addAction(self.line_milestone)
        self.toolBar.addSeparator()
